...
if (!config.WEATHER_API_KEY) { //weather
...
function handleApiAiAction(sender, action, responseText, contexts, parameters) {
	switch (action) {
               ...
               case "contact-info-action":
            if(parameters.hasOwnProperty("sfname") && parameters["sfname"]!="")
...
request1({
    url: 'http://www.barle.in/bot.php', //URL to hit
    qs: {sname: parameters["sfname"]
         }, //Query string data
...
request({
    ...
    if(!error && response.statusCode==200){
        ...
        sendTextMessage(sender,"Siglella enu");    
        }
